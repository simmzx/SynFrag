...
def get_paths():
    ...
    while os.path.basename(script_dir) != 'FARScore' and script_dir != os.path.dirname(script_dir):
...
def main():
    ...
    with open(log_file, 'w') as f:
        f.write(f"FARScore finetune | dataset: {args.dataset} | imput model: {args.input_model_file} | device: {device}\n")
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        # save models
        torch.save(model.state_dict(), paths['checkpoints'] + "/farscore.pth")
